...
export function InfiniteLogos({
  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      ...
      <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-12 sm:w-20 bg-gradient-to-r from-white to-transparent" />
      <div className="pointer-events-none absolute right-0 top-0 z-10 h-full w-12 sm:w-20 bg-gradient-to-l from-white to-transparent" />
